// Pricing is hidden from organizer view (admin/finance only)
...
export default function MyBookings() {
  const { bookings, cancelBooking, user, token, toEthTime } = useApp();
