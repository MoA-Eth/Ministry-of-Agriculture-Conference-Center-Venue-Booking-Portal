...
# --- FILE UPLOAD LIMITS ---
DATA_UPLOAD_MAX_MEMORY_SIZE = 15 * 1024 * 1024   # 15 MB – max non-file POST body
FILE_UPLOAD_MAX_MEMORY_SIZE = 10 * 1024 * 1024   # 10 MB – files up to this are kept in memory
